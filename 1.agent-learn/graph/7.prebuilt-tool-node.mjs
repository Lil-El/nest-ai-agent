...
import { interrupt, START, END, Annotation, StateGraph, MessagesAnnotation } from "@langchain/langgraph";
...
const getProduct = tool(async ({ sku }) => getProductBySku(sku), {
