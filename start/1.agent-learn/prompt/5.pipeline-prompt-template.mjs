...
import { personaPrompt, contextPrompt } from "./2.pipeline-prompt-template.mjs";
...
const weeklyChatPipelinePrompt = new PipelinePromptTemplate({
  ...
  inputVariables: ["tone", "company_name", "team_name", "manager_name", "week_range", "team_goal", "dev_activities"],
});
